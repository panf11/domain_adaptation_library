...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    transfer_losses = AverageMeter('Domain confusion loss', '3.1f')
    cls_accs = AverageMeter('Source Cls Acc', ':3.1f')
    ...
    writer.add_scalar('Loss_domain_confusion/Train', transfer_losses.avg, epoch)
...
#     python dann_wind.py data/wind -d Wind -s R -t C -a resnet50 -b 16 --epochs 20 -i 2500
